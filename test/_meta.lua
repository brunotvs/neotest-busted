...
---@alias BustedTestFunction fun(dec:string, inner:BustedTestFunction)

---@type BustedTestFunction
function describe(desc, inner) end

---@param desc string
---@param inner fun()
function it(desc, inner) end

---@alias BustedUtilFunctions fun(callback:fun())

---@type BustedUtilFunctions
